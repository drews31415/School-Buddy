...
**Product Requirements Document | v2.0 | 2025**

| 변경 이력 | 내용 |
|---|---|
| v1.0 | 최초 작성 |
| v2.0 | 한양 프로젝트 AWS 제약 반영 (리전 변경, Redis→DynamoDB 캐시, VPC 제거, IAM Role 고정, S3 버킷명 규칙, CI/CD 방식 변경) |
...
*School Buddy PRD v2.0 | © 2025 School Buddy | product@schoolbuddy.kr*
